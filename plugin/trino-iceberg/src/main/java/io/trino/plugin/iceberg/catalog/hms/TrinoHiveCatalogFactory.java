        ...
        implements TrinoCatalogFactory
{
    ...
    {
        return new TrinoHiveCatalog(catalogName, memoizeMetastore(metastore, 1000), hdfsEnvironment, typeManager, tableOperationsProvider,
                trinoVersion, isUniqueTableLocation, warehouse);
    }
}
